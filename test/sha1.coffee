...
describe 'sha1', ->
	describe 'sha1.encode', ->
		...
		it 'basically works', ->
			expect sha1.encode new Buffer 'The quick brown fox jumps over the lazy dog', 'ascii'
			.to.be.a 'string'
			.and.equal '2fd4e1c67a2d28fced849ee1bb76e7391b93eb12'

			expect sha1.encode new Buffer 'The quick brown fox jumps over the lazy cog', 'ascii'
			.to.be.a 'string'
			.and.equal 'de9f2c7fd25e1b3afad3e85a0bd17d9b100db4b3'

			expect sha1.encode new Buffer '', 'ascii'
			.to.be.a 'string'
